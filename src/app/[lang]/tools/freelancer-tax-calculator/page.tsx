  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <header className="mb-8">
        ...
        <ToolAbout slug="freelancer-tax-calculator" locale={locale} />
      </header>
      ...
      <ToolHowItWorks slug="freelancer-tax-calculator" locale={locale} />
      <ToolDisclaimer slug="freelancer-tax-calculator" locale={locale} />
