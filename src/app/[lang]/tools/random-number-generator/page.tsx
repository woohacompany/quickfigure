  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <header className="mb-8">
        ...
        <ToolAbout slug="random-number-generator" locale={locale} />
      </header>
      ...
      <ToolHowItWorks slug="random-number-generator" locale={locale} />
      <ToolDisclaimer slug="random-number-generator" locale={locale} />
