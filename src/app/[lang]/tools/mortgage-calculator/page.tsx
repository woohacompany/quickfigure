  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <header className="mb-8">
        ...
        <ToolAbout slug="mortgage-calculator" locale={locale} />
      </header>
      ...
      <ToolHowItWorks slug="mortgage-calculator" locale={locale} />
      <ToolDisclaimer slug="mortgage-calculator" locale={locale} />
