  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <header className="mb-8">
        ...
        <ToolAbout slug="emergency-fund-calculator" locale={locale} />
      </header>
      ...
      <ToolHowItWorks slug="emergency-fund-calculator" locale={locale} />
      <ToolDisclaimer slug="emergency-fund-calculator" locale={locale} />
