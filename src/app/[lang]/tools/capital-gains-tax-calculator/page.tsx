  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <header className="mb-8">
        ...
        <ToolAbout slug="capital-gains-tax-calculator" locale={locale} />
      </header>
      ...
      <ToolHowItWorks slug="capital-gains-tax-calculator" locale={locale} />
      <ToolDisclaimer slug="capital-gains-tax-calculator" locale={locale} />
