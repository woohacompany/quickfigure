  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <header className="mb-8">
        ...
        <ToolAbout slug="css-gradient-generator" locale={locale} />
      </header>
      ...
      <ToolHowItWorks slug="css-gradient-generator" locale={locale} />
      <ToolDisclaimer slug="css-gradient-generator" locale={locale} />
